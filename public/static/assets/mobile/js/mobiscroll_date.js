    ...
    function Scroller(elem, settings) {
        ...
        function generateWheelItems(i) {
            ...
            for (j in warr[i]) {
                ...
                html += '<div class="dw-li dw-v" data-val="' + j + '" style="height:' + hi + 'vw;line-height:' + hi + 'vw;"><div class="dw-i">' + warr[i][j] + '</div></div>';
                l++;
            }
            html += '</div>';
            return html;
        ...
        */
        that.scroll = function (t, index, val, time, orig) {
            ...
            pixels[index] = px/375*100;
            
            t.attr('style', (prefix + '-transition:all ' + (time ? time.toFixed(3) : 0) + 's ease-out;') + (has3d ? (prefix + '-transform:translate3d(0,' + px + 'vw,0);') : ('top:' + px + 'vw;')));
        ...
        that.show = function (prevAnim) {
            ...
            for (i = 0; i < s.wheels.length; i++) {
                ...
                for (label in s.wheels[i]) {
                    ...
                    html += '<td><div class="dwwl dwrc dwwl' + l + '">' + (s.mode != 'scroller' ? '<div class="dwwb dwwbp" style="height:' + hi + 'vw;line-height:' + hi + 'vw;"><span>+</span></div><div class="dwwb dwwbm" style="height:' + hi + 'vw;line-height:' + hi + 'vw;"><span>&ndash;</span></div>' : '') + '<div class="dwl">' + label + '</div><div class="dww" style="height:' + (s.rows * hi) + 'vw;min-width:' + s.width/375*100 + 'vw;"><div class="dw-ul">';
                    // Create wheel values
